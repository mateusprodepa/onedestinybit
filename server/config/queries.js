...
module.exports = {
  ...
  get_user_data: function(id) {
    return `SELECT ${TABLES.U00_USUARIOS}.Codigo, ${TABLES.U00_USUARIOS}.id, ${TABLES.U00_USUARIOS}.username, ${TABLES.U01_INFO_USUARIOS}.nickname, ${TABLES.U01_INFO_USUARIOS}.Codigo, ${TABLES.U01_INFO_USUARIOS}.Descricao_Usuario, ${TABLES.U01_INFO_USUARIOS}.Usuario_Status, ${TABLES.U01_INFO_USUARIOS}.Usuario_Imagem FROM ${TABLES.U00_USUARIOS}, ${TABLES.U01_INFO_USUARIOS} WHERE ${TABLES.U01_INFO_USUARIOS}.Id_Usuario = ${id} AND ${TABLES.U00_USUARIOS}.id = ${id}`
  },
